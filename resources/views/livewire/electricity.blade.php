                                    ...
                                    <div class="modal-body">
                                        <ul class="list-group">
                                            ...
                                            <li class="list-group-item mb-3 ">
                                                ...
                                                <br>
                                                <a target="_blank" href="{{route('house_state.ImprimeElectricityHouseState',crypId($state->id))}}" class="btn btn-sm bg-red"><i class="bi bi-file-earmark-pdf-fill"> </i> Imprimer</a>
                                            </li>
                                            @endforeach
                                        </ul>
