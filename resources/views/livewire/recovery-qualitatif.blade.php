<div>
    ...
    <div id="show_action_buttons" hidden>
        <a class="btn btn-sm btn-light" target="_blank" href="{{route('taux._ShowAgencyTauxQualitatif_Simple',crypId($agency->id))}}"><i class="bi bi-house-dash"></i> Pour cette agence</a>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item" style="justify-content: space-between!important">{{$supervisor->name}} &nbsp; <a target="_blank" href="{{route('taux._ShowAgencyTauxQualitatif_By_Supervisor',['agencyId'=>crypId($agency->id),'supervisor'=>crypId($supervisor->id)])}}" class="btn btn-sm btn-light text-red"><i class="bi bi-eye"></i></a> </li>
                        @endforeach
                    </ul>
            ...
            <div class="modal-content">
                <div class="modal-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item" style="justify-content: space-between!important">{{$house->name}} &nbsp; <a target="_blank" href="{{route('taux._ShowAgencyTauxQualitatif_By_House',['agencyId'=>crypId($agency->id),'house'=>crypId($house->id)])}}" class="btn btn-sm btn-light text-red"><i class="bi bi-eye"></i></a> </li>
                        @endforeach
                    </ul>
