...
class StopHouseElectricityStateController extends ELECTRICITY_HOUSE_STOP_STATE_HELPER
{
    ...
    function ImprimeElectricityHouseState(Request $request, $state)
    {
        #VERIFICATION DE LA METHOD
        if ($this->methodValidation($request->method(), "GET") == False) {
            #RENVOIE D'ERREURE VIA **sendError** DE LA CLASS Card_HELPER
        ...
        return $this->_imprimeElectricityHouseState($state);
    }
