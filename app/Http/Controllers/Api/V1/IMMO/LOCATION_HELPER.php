...
class LOCATION_HELPER extends BASE_HELPER
{
    ...
    {
        $user = request()->user();
        $locations = Location::where(["visible" => 1])->with(["_Agency", "Owner", "House", "Locataire", "Type", "Room", "Status", "Factures", "Paiements", "WaterFactures", "ElectricityFactures"])->get();
    ...
    {
        $user = request()->user();
        $location = Location::where(["visible" => 1])->with(["_Agency", "Owner", "House", "Locataire", "Type", "Room", "Status", "Factures", "Paiements", "WaterFactures", "ElectricityFactures"])->find($id);
        if (!$location) {
