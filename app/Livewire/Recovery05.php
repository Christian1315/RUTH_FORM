...
class Recovery05 extends Component
{
    ...
    function showGenerateTaux()
    {
        ...
        $response = Http::withHeaders($this->headers)->get($this->BASE_URL . "immo/locataire/" . $this->agency['id'] . "/imprime_taux_05_agency")->json();
    ...
    function GenerateTauxBySupervisor()
    {
        ...
        if (!$this->supervisor) {
            ...
            $response = Http::withHeaders($this->headers)->post($this->BASE_URL . "immo/locataire/" . $this->agency['id'] . "/$this->supervisor/imprime_taux_05_supervisor", $data)->json();
    ...
    function GenerateTauxByHouse()
    {
        ...
        if (!$this->house) {
            ...
            $response = Http::withHeaders($this->headers)->post($this->BASE_URL . "immo/locataire/" . $this->agency['id'] . "/$this->house/imprime_taux_05_house", $data)->json();
    ...
    {
        $response = Http::withHeaders($this->headers)->get($this->BASE_URL . "immo/locataire/$agencyId/recovery_05_to_echeance_date")->json();
